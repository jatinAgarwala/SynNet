...
class TestOptimization(unittest.TestCase):
    ...
    def test_mutation(self):
        ...
        offspring = mutation(
            offspring_crossover=population,
            num_mut_per_ele=4,
            mut_probability=0.5)
        new_scores = np.array([fitness_sum(_) for _ in offspring])
    ...
    def test_generation(self):
        ...
        for _ in range(ngen):
            ...
            for parent_idx in range(num_parents):
                max_score_idx = np.where(
                    new_scores == np.max(new_scores))[0][0]
        ...
        new_scores_ref = np.array([-9.99999e+05, 8.10000e+01, 8.10000e+01,
                                   7.90000e+01, 7.90000e+01, 7.80000e+01,
                                   7.70000e+01, 7.60000e+01, 7.60000e+01,
                                   7.50000e+01, 7.00000e+01, 7.80000e+01,
                                   7.30000e+01, 7.00000e+01, 8.10000e+01,
                                   8.00000e+01, -9.99999e+05, 7.80000e+01,
                                   7.30000e+01, -9.99999e+05, 7.40000e+01, -
                                   9.99999e+05, 7.90000e+01, 7.60000e+01,
                                   7.80000e+01, 7.90000e+01, 7.50000e+01,
                                   7.90000e+01, -9.99999e+05, -9.99999e+05, -
                                   9.99999e+05, -9.99999e+05, -9.99999e+05,
                                   7.90000e+01, 7.30000e+01, 7.20000e+01,
                                   7.60000e+01, -9.99999e+05, 7.70000e+01,
                                   8.00000e+01])
